...
export class InventoryRepository {
  ...
  async getInventoryItems(
    ...
    const effectivePageSize = usePagination ? pageSize : totalItems || items.length || 1;
  ...
  async getInventoryMovements(
    ...
    const effectivePageSize =
      usePagination ? pageSize : totalItems || movements.length || 1;
    const effectivePage = usePagination ? page : 1;
  ...
  async findMovementById(movementId: string): Promise<InventoryMovement | null> {
