          ...
          <div className="bg-muted/20 border-t px-4 py-4">
            ...
            <div className="mt-4 rounded-2xl border bg-background p-4">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                <button className="inline-flex items-center gap-2 rounded-full border bg-muted/40 px-3 py-1.5 text-sm font-medium">
                  Active
                </button>
                <button className="inline-flex items-center gap-2 rounded-full border px-3 py-1.5 text-sm text-muted-foreground">
                  Inventory tracked
                </button>
                <button className="inline-flex items-center gap-2 rounded-full border px-3 py-1.5 text-sm text-muted-foreground">
                  Sellable
